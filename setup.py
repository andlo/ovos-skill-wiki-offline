...
URL = "https://github.com/andlo/ovos-skill-wiki-offline"
SKILL_CLAZZ = "WikiOffline"
PYPI_NAME = "ovos-skill-wiki-offline"
...
setup(
    name=PYPI_NAME,
    version=get_version(),
    description="Fully offline general-knowledge fallback for OVOS, covering Wikipedia's own ~9,000 Level 4 Vital Articles - an offline alternative to Wikipedia/DDG/Wolfram Common Query skills",
    ...
    keywords="ovos skill voice assistant offline wikipedia encyclopedia common query fallback",
